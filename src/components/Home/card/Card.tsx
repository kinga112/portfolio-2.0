...
export function Card() {
  ...
  return (
		...
		<div className={"mt-20 " + animation}>
			<CardContainer>
				{showFlipped ? 
        <CardBody className="bg-custom-500 relative group/card shadow-lg shadow-custom-950 h-[275px] w-[450px] rounded-xl p-6 border-4 border-custom-950">
          <CardItem
            translateZ={60}
            className="text-4xl text-custom-950"
          >
            Alden King
          </CardItem>
          <CardItem
            ...
            translateX={5}
            translateY={-5}
            className="pt-10 w-full text-center text-2xl font-light text-custom-950"
          >
            I am a creator, explorer, skier ...
          </CardItem>
          <CardItem
            translateZ={50}
            translateX={10}
        ...
        <CardBody className="flex bg-custom-500 z-10 relative group/card shadow-lg shadow-custom-950 h-[275px] w-[450px] rounded-xl p-6 border-4 border-custom-950">
          <div className="flex flex-col w-[60%]">
            <CardItem
              translateZ={60}
              className="text-4xl font-normal text-custom-950"
            >
              Alden King
            </CardItem>
            <CardItem
              as="p"
              translateZ={50}
              className="text-custom-950 text-2xl pb-2 font-light max-w-sm mt-2"
            >
              Software Engineer
            </CardItem>
            <CardItem
          ...
          <div className="flex flex-col w-[40%]">
            <CardItem
              ...
              className="pl-5"
            >
              <img className='w-40 h-48 rounded-xl' src={image}/>
            </CardItem>
          </div>
          <CardItem
            translateZ={50}
